...
class ContactWidgetWebView extends StatefulWidget {
  final GlobalKey contactKey;
  const ContactWidgetWebView({super.key, required this.contactKey});

  @override
  State<ContactWidgetWebView> createState() => _ContactWidgetWebViewState();
}

class _ContactWidgetWebViewState extends State<ContactWidgetWebView> {
